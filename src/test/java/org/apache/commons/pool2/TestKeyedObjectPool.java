...
public abstract class TestKeyedObjectPool {
	...
	/**
	 * Create an {@code KeyedObjectPool} with the specified factory. The pool should
	 * be in a default configuration and conform to the expected behaviors described
	 * in {@link KeyedObjectPool}. Generally speaking there should be no limits on
	 * the various object counts.
	 *
	...
	/**
	 * Create an {@link KeyedObjectPool} instance that can contain at least
	 * <i>minCapacity</i> idle and active objects, or throw
	...
	/**
	 * Return what we expect to be the n<sup>th</sup> object (zero indexed) created
	 * by the pool for the given key.
	 * 
	...
	public void testKPOFBorrowObjectUsages() throws Exception {
		...
		TestObjectPool.removeDestroyObjectCall(factory.getMethodCalls()); // The exact timing of destroyObject is
																			// flexible here.
		assertEquals(expectedMethods, factory.getMethodCalls());
	...
	private void reset(final KeyedObjectPool<Object, Object> pool, final FailingKeyedPooledObjectFactory factory,
